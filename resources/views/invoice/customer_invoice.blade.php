...
<head>
  ...
  <title>{{(Utility::companyData($invoice->created_by,'title_text')) ? Utility::companyData($invoice->created_by,'title_text') : config('app.name', 'SellfizERP')}} - {{__('Invoice')}}</title>
                                  ...
                                  <ul class="nav nav-pills  mb-3" role="tablist">
                                      ...
                                      @endif
                                          ...
                                          @if(isset($company_payment_setting['is_benefit_enabled']) && $company_payment_setting['is_benefit_enabled'] == 'on')
                                              <li class="nav-item mb-2">
                                                  <a class="btn btn-outline-primary btn-sm me-1 ml-1" data-bs-toggle="tab" href="#benefit-payment" role="tab" aria-controls="benefit" aria-selected="false">{{ __('Benefit') }}</a>
                                              </li>
                                          @endif
                                      ...
                                      @if(isset($company_payment_setting['is_benefit_enabled']) && $company_payment_setting['is_benefit_enabled'] == 'on')
                                          <div class="tab-pane fade" id="benefit-payment" role="tabpanel" aria-labelledby="benefit-payment">
                                              <form role="form" action="{{ route('invoice.benefit.initiate') }}" method="post" class="require-validation" id="benefit-payment-form">
                                                  ...
                                                  <div class="form-group mt-3">
                                                      <button class="btn btn-primary" name="submit"  id="pay_with_benefit" type="submit">{{ __('Make Payment') }}</button>
                                                  </div>
                                              </form>
                                          </div>
                                      @endif
                                      ...
                                      @if(isset($company_payment_setting['is_cashfree_enabled']) && $company_payment_setting['is_cashfree_enabled'] == 'on')
                                          <div class="tab-pane fade" id="cashfree-payment" role="tabpanel" aria-labelledby="cashfree-payment">
                                              <form role="form" action="{{ route('customer.pay.with.cashfree') }}" method="post" class="require-validation" id="cashfree-payment-form">
                                                  ...
                                                  <div class="form-group mt-3">
                                                      <button class="btn btn-primary" name="submit"  id="pay_with_cashfree" type="submit">{{ __('Make Payment') }}</button>
                                                  </div>
                                              </form>
                                          </div>
                                      @endif
...
<script type="text/javascript">
  ...
  @endif
    ...
    @if (isset($company_payment_setting['is_payfast_enabled']) && $company_payment_setting['is_payfast_enabled'] == 'on' && !empty($company_payment_setting['payfast_merchant_id']) && !empty($company_payment_setting['payfast_merchant_key']))
