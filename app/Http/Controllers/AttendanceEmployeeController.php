...
//                dd($attendanceEmployee->toSql(), $attendanceEmployee->getBindings());
    ...
    public function update(Request $request, $id)
    {
        if (\Auth::user()->type == 'company' || \Auth::user()->type == 'HR') {
            ...
            if (empty($request->employee_id) || empty($request->date)) {
                return redirect()->route('attendanceemployee.index')->with('error', __('Employee ID and date are required.'));
            }
            ...
            // Check if attendance record exists and if it's for today
